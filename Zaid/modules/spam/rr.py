...
@Client.on_message(filters.command("rraid","rgali", prefixes=".") & (filters.me | filters.user(SUDO_USER))
)
...
@Client.on_message(filters.command("drraid","dgali", prefixes=".") & (filters.me | filters.user(SUDO_USER))
)
